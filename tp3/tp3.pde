///www.youtube.com/watch?v=uiKNpTxKLVA el video es el mismo porque solo modifiqué el arreglo de pantallas por una variable,
// simplifique el booleano final y llame los parametros directamente en la linea del return.
